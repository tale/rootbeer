...
pub fn extract_archive(archive: &Path, format: ArchiveFormat, dest: &Path) -> io::Result<()> {
...
pub fn validate_relative_path(label: &str, path: &Path) -> io::Result<()> {
